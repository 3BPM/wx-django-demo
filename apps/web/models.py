...
class DeployTask(models.Model):
    ...
    env = models.ForeignKey(verbose_name='环境', to='ProjectEnv', on_delete=models.CASCADE)
...
class DeployServer(models.Model):
    ...
    上线记录
    """
    deploy = models.ForeignKey(verbose_name='发布任务', to='DeployTask', on_delete=models.CASCADE)
...
class Diagram(models.Model):
    """发布图标"""
    task = models.ForeignKey(verbose_name='发布任务', to='DeployTask', on_delete=models.CASCADE)
    ...
    deploy_record = models.ForeignKey(verbose_name='服务器发布记录', to='DeployServer', null=True, blank=True, on_delete=models.CASCADE)
